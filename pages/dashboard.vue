<template>
  <div class="dashboard__container">
    ...
    <div class="dashboard__actions-grid">
      ...
      >
        <div class="dashboard__action-content">
          <i class="fas fa-calendar-alt dashboard__action-icon dashboard__action-icon--attendance" />
          <div>
            <h3 class="dashboard__action-title">
              勤怠一覧
            </h3>
            <p class="dashboard__action-desc">
              過去の勤怠記録を確認・修正申請
            </p>
          </div>
        </div>
      ...
      >
        <div class="dashboard__action-content">
          <i class="fas fa-clipboard-list dashboard__action-icon dashboard__action-icon--requests" />
          <div>
            <h3 class="dashboard__action-title">
              修正申請一覧
            </h3>
    ...
    <div class="dashboard__summary-section">
      <h2 class="dashboard__summary-title">
        今月の勤怠サマリー
      </h2>
      <div class="dashboard__summary-grid">
        <div class="dashboard__stat-card dashboard__stat-card--work-days">
          <div class="dashboard__stat-value dashboard__stat-value--work-days">
        ...
        <div class="dashboard__stat-card dashboard__stat-card--total-hours">
          <div class="dashboard__stat-value dashboard__stat-value--total-hours">
        ...
        <div class="dashboard__stat-card dashboard__stat-card--average-hours">
          <div class="dashboard__stat-value dashboard__stat-value--average-hours">
        ...
        <div class="dashboard__stat-card dashboard__stat-card--pending">
          <div class="dashboard__stat-value dashboard__stat-value--pending">
            {{ monthlyStats.pendingRequests }}
          </div>
          <div class="dashboard__stat-label">
            承認待ち申請
          </div>
