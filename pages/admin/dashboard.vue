<template>
  <div class="admin-dashboard__container">
    ...
    <div class="admin-dashboard__menu-grid">
      ...
      >
        <div class="admin-dashboard__menu-content">
          <i class="fas fa-calendar-day admin-dashboard__menu-icon admin-dashboard__menu-icon--daily" />
          <h3 class="admin-dashboard__menu-title">
            日次勤怠一覧
          </h3>
        </div>
        <p class="admin-dashboard__menu-desc">
          日毎の全スタッフ勤怠状況を確認
        </p>
      </nuxt-link>
      ...
      >
        <div class="admin-dashboard__menu-content">
          <i class="fas fa-users admin-dashboard__menu-icon admin-dashboard__menu-icon--staff" />
          <h3 class="admin-dashboard__menu-title">
            スタッフ一覧
          </h3>
        </div>
      ...
      >
        <div class="admin-dashboard__menu-content">
          <i class="fas fa-edit admin-dashboard__menu-icon admin-dashboard__menu-icon--requests" />
          <h3 class="admin-dashboard__menu-title">
            修正申請管理
          </h3>
        </div>
    ...
    <div class="admin-dashboard__activity-section">
      <h2 class="admin-dashboard__activity-title">
        最近の活動
      </h2>
      <div class="admin-dashboard__activity-list">
        <div v-for="activity in recentActivities" :key="activity.id" class="admin-dashboard__activity-item">
          <i :class="activity.icon" class="admin-dashboard__activity-icon" />
          <div class="admin-dashboard__activity-content">
            <p class="admin-dashboard__activity-message">
              {{ activity.message }}
            </p>
